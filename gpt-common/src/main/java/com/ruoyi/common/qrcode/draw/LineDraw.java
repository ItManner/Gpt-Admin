package com.ruoyi.common.qrcode.draw;
...
public class LineDraw {
    ...
    // 绘制交叉线（和点）
    public void drawCross(ByteMatrix matrix, Graphics2D graphics, int lineStroke, List<int[]> pointList) {
        // 1 画线
        for (int[] point : pointList) {
    ...
    // 左右 pass
    private List<int[]> getPointLeftRight(ByteMatrix matrix){
    ...
    // 上下 pass
    private List<int[]> getPointUpDown(ByteMatrix matrix){
        int matrixSide = matrix.getWidth();
        List<int[]> list = new ArrayList<>();
        for (int x = 0; x < matrixSide; x++) {
            for (int y = 0; y < matrixSide; y++) {
    ...
    // 纵横 pass  !!! 修改了 matrix
    private List<int[]> getPointVerticalHorizontal(ByteMatrix matrix){
        int matrixSide = matrix.getWidth();
        List<int[]> list = new ArrayList<>();
        for (int y = 0; y < matrixSide; y++) {
            for (int x = 0; x < matrixSide; x++) {
    ...
    // 回环 pass   !!! 修改了 matrix
    private List<int[]> getPointLoopback(ByteMatrix matrix){
        int matrixSide = matrix.getWidth();
        List<int[]> list = new ArrayList<>();
        for (int y = 0; y < matrixSide; y++) {
            for (int x = 0; x < matrixSide; x++) {
    ...
    // 左上右下 pass
    private List<int[]> getPointTopLeftBottomRight(ByteMatrix matrix){
        int matrixSide = matrix.getWidth();
        List<int[]> list = new ArrayList<>();
    ...
    // 右上左下 pass
    private List<int[]> getPointTopRightBottomLeft(ByteMatrix matrix){
        int matrixSide = matrix.getWidth();
        List<int[]> list = new ArrayList<>();
        for (int x = 0; x < matrixSide; x++) {
    ...
    // 交叉
    private List<int[]> getPointCross(ByteMatrix matrix){
